...
const translations = {
  es: {
    ...
    realized: "Realizados",
    recentRoutines: "Rutinas recientes",
    recentActivity: "Actividad reciente",
    notifications: "Notificaciones",
    home: "Inicio",
    activeStudents: "Alumnos activos",
    createdRoutines: "Rutinas creadas",
    personalInformation: "Información personal",
    profileAdmin: "Perfil Admin",
    trainerProfile: "Perfil del Profesor",
    studentProfile: "Perfil del Alumno",
    adminInformation: "Información admin",
    trainerInformation: "Información del profesor",
    settings: "Ajustes",
    ...
    supportMessage: "Soporte RutFit: escribe a tu entrenador o administrador.",
    resetMailSent: "Te enviamos un mail para cambiar la contraseña.",
    metricMessage: "RutFit usa sistema métrico: kg y cm.",
    privacyMessage: "Tus datos solo se usan para RutFit y tus entrenadores aceptados.",
    deleteAccountConfirm: "¿Eliminar tu cuenta de RutFit?",
    deleteAccountHelp: "Para eliminar la cuenta definitivamente, vuelve a iniciar sesión recientemente y solicita eliminación al admin.",
  ...
  en: {
    ...
    createdRoutines: "Created routines",
    ...
    supportMessage: "RutFit support: contact your trainer or administrator.",
    resetMailSent: "We sent you an email to change your password.",
    metricMessage: "RutFit uses the metric system: kg and cm.",
    privacyMessage: "Your data is only used for RutFit and your accepted trainers.",
    deleteAccountConfirm: "Delete your RutFit account?",
    deleteAccountHelp: "To permanently delete the account, sign in again recently and request deletion from the admin.",
  ...
  pt: {
    ...
    storageNotReady: "A imagem é salva dentro da rotina.",
    ...
    realized: "Realizados",
    recentRoutines: "Rotinas recentes",
    recentActivity: "Atividade recente",
    notifications: "Notificações",
    home: "Início",
    activeStudents: "Alunos ativos",
    createdRoutines: "Rotinas criadas",
    personalInformation: "Informações pessoais",
    profileAdmin: "Perfil Admin",
    trainerProfile: "Perfil do Professor",
    studentProfile: "Perfil do Aluno",
    adminInformation: "Informações admin",
    trainerInformation: "Informações do professor",
    settings: "Ajustes",
    ...
    supportMessage: "Suporte RutFit: fale com seu treinador ou administrador.",
    resetMailSent: "Enviamos um email para alterar sua senha.",
    metricMessage: "RutFit usa o sistema métrico: kg e cm.",
    privacyMessage: "Seus dados são usados apenas para RutFit e seus treinadores aceitos.",
    deleteAccountConfirm: "Excluir sua conta RutFit?",
    deleteAccountHelp: "Para excluir a conta definitivamente, entre novamente recentemente e solicite a exclusão ao admin.",
